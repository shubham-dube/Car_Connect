import 'dart:async';
import 'serviceAddedDialog.dart';
...
class ServiceForm extends StatefulWidget {
  const ServiceForm();
  @override
  _ServiceForm createState() => _ServiceForm();
}

class _ServiceForm extends State<ServiceForm> {
  final _formKey = GlobalKey<FormState>();
  var formState ;

  bool imageSelected=false;
  late File _image;
  var _title, _description, _duration, _price, _category;
  ...
  void addService() async {
    ...
    var reqBody = {
      "merchantId": mobile,
      "serviceId": 'Service${DateTime.now()}',
      "imageUrl": imageURL,
      "title": _title,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text("Image", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold),),
                            ),
...
void showProductAddedDialog(BuildContext context) {
  showDialog(
    ...
    builder: (context) => const ServiceAddedDialog(),
  );
}